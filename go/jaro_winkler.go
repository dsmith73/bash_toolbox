 package main
// detect if a paragraph or an article has a pattern of using multiple words with high similarities.  
// useful in detecting a pattern to see if it is written by a same person,  
// multiple persons or generated by computer programs.  
